      ...
      <section className={styles.container}>
        <div className={styles.top}>
          ...
          <h2 className={styles.description}>
            ...
            친구를 만들기로 결심하고 마침내 무지를 탄생시킵니다. 하지만 귀여워
            보이는 토끼의 모습과는 다르게 무지의 정체는 사실 단무지였습니다.
            무지를 키우는 데 여념이 없는 콘과는 다르게 커가면서 점차 자아가
            강해지는 무지는 바깥 세상에 대한 호기심을 참지 못하고 늘 탈출을
            시도합니다. 이를 지켜보던 콘은 결국 다른 친구들과의 만남을
